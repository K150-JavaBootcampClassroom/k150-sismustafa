 ...
 * @author Asus
 */
public class PersonService extends ServiceInfo implements IService {
    ...
    public PersonService(Customer customer, ArrayList<Car> cars) {
    ...
    public boolean transactions() {
        System.out.println("\nBireysel Hesap - Hosgeldin " + customer.getName());
        System.out.println("=============================");
    ...
    public void allCar() {
        if (customer.getCar() == null) {
            System.out.println("--------------------\nKiralanabilinir Arabalar\n--------------------");
            for (int i = 0; i < cars.size(); i++) {
                if (cars.get(i).getClass().getSimpleName().equals("Hatchback")) {
